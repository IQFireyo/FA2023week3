function playGame(){
    ...
    if (sum == 7 || sum == 11) {
      document.getElementById("finRes").setAttribute("style", "background-color: Red;");
        document.getElementById("finRes").innerHTML = "You Lose"
      } else if (die1=die2 & die1 % 2 == 0){
        document.getElementById("finRes").setAttribute("style", "background-color: Green;");
        document.getElementById("finRes").innerHTML = "You WIN, Thats Some Crazy Luck"
      }else{
        document.getElementById("finRes").setAttribute("style", "background-color: purple;");
